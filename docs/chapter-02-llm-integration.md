...
- The direct chat companion seam also exposes a tiny async batch demo that shows server-side concurrent handling of multiple direct prompts in one request, with bounded concurrency and per-prompt failure isolation.
