...
- Chapter 7 has moved beyond a tiny demo seam: the runtime now exposes a small task-plan tool, a reflection tool, a plan/reflection/replan trace story, and a session/context-based re-entry cycle that is still lightweight but materially more book-faithful.
